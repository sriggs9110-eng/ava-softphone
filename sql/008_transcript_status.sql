-- Mirror of supabase/migrations/20260422_transcript_status.sql
...
CREATE INDEX IF NOT EXISTS call_logs_transcript_status_idx ON call_logs (transcript_status);
CREATE INDEX IF NOT EXISTS call_logs_ai_status_idx ON call_logs (ai_status);
