-- Mirror of supabase/migrations/20260423_reporting_metrics.sql
...
CREATE INDEX IF NOT EXISTS call_logs_user_created_idx ON call_logs (user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS call_logs_created_idx ON call_logs (created_at DESC);
CREATE INDEX IF NOT EXISTS call_logs_objection_tags_gin ON call_logs USING gin (objection_tags);
CREATE INDEX IF NOT EXISTS call_logs_topic_tags_gin ON call_logs USING gin (topic_tags);
